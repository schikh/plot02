/* 
    ...
    Template element id: adsk_ptw_page_title
    Publishing contents: title
                         page description

*/

adsk_ptw_page_title_main();

function adsk_ptw_page_title_main() {
    var xmle=adsk_ptw_xml.getElementsByTagName("publish_to_web").item(0);
    xmle=xmle.getElementsByTagName("header").item(0);
    xmle=xmle.getElementsByTagName("banner").item(0);
    var e = document.getElementById("adsk_ptw_page_title");
...
// SIG // AAIBAAIBAAIBAAIBADAgMAwGCCqGSIb3DQIFBQAEEBWL
// SIG // pNhHd4ZmMitiY3uMfw+ggg+PMIICvDCCAiUCEEoZ0jiM
...
// SIG // CQQxEgQQBbea7s5LZiorYxDDV1fW0TBUBgorBgEEAYI3
// SIG // AgEMMUYwRKAmgCQAQQB1AHQAbwBkAGUAcwBrACAAQwBv
// SIG // AG0AcABvAG4AZQBuAHShGoAYaHR0cDovL3d3dy5hdXRv
// SIG // ZGVzay5jb20gMA0GCSqGSIb3DQEBAQUABIGAvruflgDc
// SIG // HKAXniR0m+uofanh//ucXzZjrSJyUhzNowdiTIrm0p2n
// SIG // rsjUDxwd7kjG+pj4JSQ2zq7sywy1XcF2iTUnKaFhVoCf
// SIG // bT5x8YyPAEuQbjB3jDm7LyTIxYj15Au6Xz+Pqlj5cPmP
// SIG // ucU4WrbpjCS4vJLh/gH5nlz9S9mxPaChggJMMIICSAYJ
...
// SIG // MTMxMDY1MzU5WjAfBgkqhkiG9w0BCQQxEgQQoijQwKbb
// SIG // 97w4jZ+UOo/PuTANBgkqhkiG9w0BAQEFAASCAQB6RyNB
// SIG // BUsc6PbldEPbQS3V6J/WDyoc3LFvPNub7VfEh9OvxxaZ
// SIG // LITflOwIaodQGDxJH8lFdjJFrQoqAtlnHY1sECxVlRR6
// SIG // hRWAMWn/b0uKrzKoRL2Cj/gNuFBGg82Ystw7eIFd9sUe
// SIG // h1TVIwJJcZlyAt7RHn+7Dndk1m6cP9NimfLTkb6Xpgw+
// SIG // VY6rog/sAVgnMcZj/fALNqgo1s3AHXOnRvwbpKkS5HO1
// SIG // 5thpyTRv0cO7/7Dj4IQBRiAJntem01VBspnfaWxOJgwM
// SIG // 5JoWKroa/Bw61BgPfu7ZJLg/icAoHWaS6QFv5zJM9GRp
// SIG // r3u/TkqlC/goJHLbmjzWFmDWfBuT
